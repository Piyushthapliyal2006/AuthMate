                ...
                <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
                    <div className="flex lg:flex-1">
                        <Link to="/" className="-m-1.5 p-1.5">
                            ...
                            <img
                                alt="AuthMate Logo"
                                src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=600" // Replace with AuthMate logo
            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div className="text-center">
                        <h1 className="text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                            Fast, Secure Authentication for Your Website
                        </h1>
                ...
                >
                    <div
                        ...
                        className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%+3rem)] sm:w-[72.1875rem]"
                    />
                </div>
            </div>
        </div>
