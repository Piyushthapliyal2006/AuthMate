          ...
          <div className="relative inline-flex">
            <button
              className={`px-4 py-2 text-sm font-medium ${
                billingCycle === 'monthly' ? 'text-white bg-blue-600' : 'text-gray-700 bg-gray-200 dark:text-gray-300 dark:bg-gray-700'
              } rounded-l-lg`}
            ...
            <button
              className={`px-4 py-2 text-sm font-medium ${
                billingCycle === 'annual' ? 'text-white bg-blue-600' : 'text-gray-700 bg-gray-200 dark:text-gray-300 dark:bg-gray-700'
              } rounded-r-lg`}
