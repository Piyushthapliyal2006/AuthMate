...
const Navbar = ({
  ...
  return (
    <nav
      className={`fixed top-0 right-0 left-0 z-10 shadow-md transition-all duration-300 ${darkMode ? 'bg-gradient-to-b from-blue-50/30 to-purple-50/30 dark:from-blue-900/20 dark:to-purple-900/20' : 'bg-white text-gray-800'
        }`}
    >
